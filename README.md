...
In the Algorithms/mapper_pipeline folder lies the Metric Graph implementation. For running a demo, go to run_mapper.ipynb and run the first cells for an inmediate visualization. For that, it is recommended to activate the TFM_env Python environment (see TFM_env.yml file). 
